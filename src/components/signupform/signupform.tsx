...
const SignupForm: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex justify-center items-center bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 sm:px-6 lg:px-8 py-4 md:py-0">
            <div className="bg-white dark:bg-gray-900 p-6 sm:p-8 md:p-10 rounded-2xl shadow-2xl dark:shadow-lg w-full max-w-sm sm:max-w-md md:max-w-lg space-y-6">
                {/* Heading Section */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                className="w-full px-4 py-3 pr-12 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm sm:text-base"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            required
                            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm sm:text-base"
                        />
                    </div>
